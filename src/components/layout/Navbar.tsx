                    ...
                    <TooltipTrigger asChild>
                      <a 
                        ...
                        className={`flex items-center justify-center p-2 rounded-full transition-colors hover:bg-gray-100 dark:hover:bg-gray-800 ${
                          location.pathname === link.path ? 'text-primary dark:text-primary bg-sky-50 dark:bg-gray-800' : 'text-gray-700 dark:text-gray-300'
                        } cursor-pointer`}
                      >
                        {link.icon}
                      </a>
                  ...
                  <div key={link.name} className="relative group">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button 
                          className={`flex items-center justify-center p-2 rounded-full transition-colors hover:bg-gray-100 dark:hover:bg-gray-800 ${
                            location.pathname.includes(link.path) ? 'text-primary dark:text-primary bg-sky-50 dark:bg-gray-800' : 'text-gray-700 dark:text-gray-300'
                          }`}
                        >
                          {link.icon}
                        </button>
                    ...
                    <div className="absolute left-0 mt-2 w-48 rounded-xl shadow-lg py-1 bg-white dark:bg-gray-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                      {link.dropdownItems?.map((item) => (
                        <a
                          ...
                          href={item.path}
                          className="block px-4 py-2 text-sm font-sf text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
                        >
                          {item.name}
                        </a>
                      ))}
              ...
              !link.isDropdown ? (
                <a
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-lg text-base font-sf font-medium ${
                    location.pathname === link.path ? 'text-primary dark:text-primary bg-sky-50 dark:bg-gray-800' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
                  } cursor-pointer`}
                >
                  {link.icon}
                  {link.name}
                ...
                <div key={link.name}>
                  <button
                    ...
                    className={`flex items-center justify-between w-full px-3 py-2 rounded-lg text-base font-sf font-medium ${
                      location.pathname.includes(link.path) ? 'text-primary dark:text-primary bg-sky-50 dark:bg-gray-800' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
                    }`}
                  >
                    ...
                    <div className="pl-4 mt-1 space-y-1">
                      {link.dropdownItems?.map((item) => (
                        <a
                          ...
                          href={item.path}
                          className="block px-3 py-2 rounded-md text-sm font-sf font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
                        >
                          {item.name}
                        </a>
                      ))}
